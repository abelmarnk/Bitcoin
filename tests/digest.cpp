...
bool test_get_hash_160_vs_digeststream() {
	std::vector<std::vector<uint8_t>> test_vectors = {
	    {}, {0x00}, {0x01, 0x02, 0x03}, {'p', 'u', 'b', 'k', 'e', 'y'}, {0xde, 0xad, 0xbe, 0xef}};
...
bool test_get_hash_256_vs_digeststream() {
	std::vector<std::vector<uint8_t>> test_vectors = {
	    {}, {0x00}, {0x01, 0x02, 0x03}, {'t', 'e', 's', 't'}, {0xff, 0xee, 0xdd, 0xcc, 0xbb, 0xaa}};
...
bool test_get_sha_256_vs_streaming() {
	std::vector<std::vector<uint8_t>> test_vectors = {
	    {}, {0x00}, {0x01, 0x02, 0x03}, {'h', 'a', 's', 'h'}, {0xaa, 0xbb, 0xcc, 0xdd, 0xee}};
...
bool test_get_hash160_vs_streaming() {
	std::vector<std::vector<uint8_t>> test_vectors = {
	    {}, {0x01}, {0x01, 0x02, 0x03, 0x04}, {'s', 'e', 'g', 'w', 'i', 't'}, {0xde, 0xad, 0xbe, 0xef}};
...
bool test_get_hash256_vs_streaming() {
	std::vector<std::vector<uint8_t>> test_vectors = {{0xff, 0xff, 0xff, 0xff},
	                                                  {0x01},
	                                                  {0x00},
	                                                  {0x11},
	                                                  {0x01, 0x02, 0x03, 0x04},
