...
TEST_CASE("Block", "[block][serialization][parsing][proof-of-work]") {
	std::string block_hex = GENERATE("0100000050120119172a610421a6c3011dd330d9df07b63616c2cc1f1\
...
TEST_CASE("Block", "[block][target][bip-support]") {
	std::vector<uint8_t> first =
	    GENERATE(hex_to_std_vec("000000203471101bbda3fe307664b3283a9ef0e97d9a38a7eacd88000000000000\
00000010c8aba8479bbaa5e0848152fd3c2289ca50e1c3e58c9a4faaafbdf5803c5448ddb8455\
97e8b0118e43a81d3"));
	std::vector<uint8_t> last = GENERATE(hex_to_std_vec("02000020f1472d9db4b563c35f97c428ac903f23b7fc055d1cfc260\
00000000000000000b3f449fcbe1bc4cfbcb8283a0d2c037f961a3fdf2b8bedc14\
4973735eea707e1264258597e8b0118e5f00474"));
	std::vector<uint8_t> next = GENERATE(hex_to_std_vec("0200002099d6a70c547bbaa1a820490bd02cc378d3bc6e2046943\
8010000000000000000b66a0b024cfdf07d0dd97e18ad6ef1a411b0452129d3b\
fe3e6ebae55defec4dd95425859308d0118bc260a08"));

	std::array<bool, 3> bip_flags = GENERATE(std::array<bool, 3>{true, false, true});
